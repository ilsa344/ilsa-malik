                ...
                <div className="col-md-7 p-0 col-sm-12">
                    <nav className="navbar navbar-expand-md">
                        <ul className="navbar-nav d-flex">
                            ...
                            <li className="nav-item pl-3 pt-2">SEM</li>
                        </ul>
                    </nav>
                </div>
                <div className="col-md-5 side-cuts m-0 p-0 col-sm-12">
                    <div className="corner">
                        <a href="" className="float-right font-italic font-weight-bold mr-4 mt-2">Request a Quote <span style={{"color": "black", "z-index": "1", "font-style": "normal"}}>or (719) 577-4404</span> </a>
                    </div>
